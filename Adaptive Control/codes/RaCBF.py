...
for i in range(N):
    phi_RaCBF[i]=phi(S[i])
np.save(os.path.join(data_path,'RaCBF'),phi_RaCBF)
...
plt.savefig(os.path.join(plot_path,"RaCBF_Phi_Plot.png"),format="png", bbox_inches="tight")
plt.show()
